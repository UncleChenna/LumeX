                    ...
                    <div className="container mx-auto px-6">
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                            { filteredItems.map( ( item ) => (
                                ...
                                >
                                    <div
                                        className={ `relative h-full w-full transition-transform duration-700 transform-gpu rounded-lg overflow-hidden ${hoveredCardId === item.id || flippedCards[ item.id ] ? 'rotate-y-180' : ''
                                    ...
                                    >
                                        ...
                                        >
                                            ...
                                            />
                                            <div className="absolute inset-x-0 bottom-0 bg-gradient-to-t from-black/80 via-black/40 to-transparent p-6 flex flex-col justify-end z-10">
                                        ...
                                        <div
                                            className="absolute inset-0 backface-hidden bg-gray-900 rounded-lg p-6 flex flex-col justify-between transform rotate-y-180"
                                            style={ { backfaceVisibility: 'hidden' } }
                                        >
                                            <div>
